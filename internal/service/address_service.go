...
type AddressService interface {
	Create(ctx context.Context, userID uint64, req request.CreateAddressRequest) error
	...
	Update(ctx context.Context, id uint64, userID uint64, req request.UpdateAddressRequest) error
